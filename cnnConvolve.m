...
%       feature = zeros(8,8); % You should replace this
      p1 = patchDim * patchDim * (channel-1) + 1;
      p2 = patchDim * patchDim * channel;
      feature = fullfeature(p1:p2);
...
%       convolvedImage = convolvedImage + conv2(im, feature, 'valid');
      convolvedImage = convolvedImage + filter2(feature, im, 'valid');
